...
const Expand: FC<{ eachItem: NavbarType }> = ({ eachItem }) => {
    ...
    return (
        <li className={`${expended ? "h-48" : "h-12"} list-none`}>
            <div className="flex justify-between items-center rounded-md duration-300 py-2 px-3 hover:bg-gray-600" onClick={() => setExpended(!expended)}>
            ...
            <div className="flex flex-col space-y-1 mt-2">
                {expended && eachItem.dropDownData?.map((subItem: NavbarType, index: number) => (
