...
const ProductType = () => {
    return (
        <div className='py-16 px-2 space-y-5'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-2 text-gray-800'>

                <div className='w-full flex flex-col items-center justify-between md:flex-row  h-auto col-span-1 md:col-span-2 rounded-md px-12 bg-[#d6d6d8]'>
