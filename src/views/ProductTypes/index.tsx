    ...
    return (
        <div className='py-16 px-2'>
            ...
            <div className='grid grid-cols-4 gap-6 px-2 text-gray-800'>
                <div className='w-full flex h-auto col-span-2 rounded-md px-12 bg-[#d6d6d8]'>
                ...
                <div className='w-full row-span-2 h-full rounded-md  bg-[#efe1c7]'>
                    <div className='p-4'>
                        <p>
                            Flex Sweatshirts
                        </p>
                ...
                <div className='w-full row-span-2 h-full rounded-md  bg-[#d7d7d9]'>
                    <div className='p-4'>
                        <p>
                ...
                <div className='text-white w-full rounded-md  col-span-2 bg-[#212121] flex flex-col justify-center items-center space-y-4'>
